//This script handles the seek stering option
...
public class KinematicSeek : MonoBehaviour
{
    ...
    void Update()
    {
	 ...
	 enemy.transform.position += dingus.velocity*Time.deltaTime; //set the position to move towards the target 	 	
    }
	...
	{   
		...
		result.velocity = target.position - enemy.position; // seek
